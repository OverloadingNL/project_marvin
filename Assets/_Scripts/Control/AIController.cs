using System;
using Overloading.Utils;
using Overloading.Combat;
using Overloading.Core;
using Overloading.Movement;
using Overloading.Attributes;
using UnityEngine;
...
namespace Overloading.Control
{
    public class AIController : MonoBehaviour
    {
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawWireSphere(transform.position, shouldDistance);
