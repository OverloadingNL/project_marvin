...
namespace Overloading.Core
{
	public class MusicManager : MonoBehaviour
	{
		...
		public float delayBeforeCrossFade = 0f;
		...
		Coroutine _curSourceFadeRoutine;
		Coroutine _newSourceFadeRoutine;
		#endregion
